...
aggregation | [BasicDeviceKpiMetricAggregation](../primitives.md#basicdevicekpimetricaggregation) | no | Requester is looking for records with any of the specified aggregation.
systemNames | List<[SystemName](../primitives.md#systemname)> | no | Requester is looking for records associated with any of the specified system.