...
threshold | [Double](../primitives.md#double) | yes/no | A borderline of QoS score above which a system is considered as non-compliant. Mandatory in case of `filter` opertaiton and ignored in case of `sort` operation.