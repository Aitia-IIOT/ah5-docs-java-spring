...
The service operation **request** requires an authorization bearer header and a [ServiceRegistrationRequest](../data-models/service-registration-request.md)
JSON encoded body.
...
The service operation **request**  requires an authorization bearer header, and a [Name](../primitives.md#name) as path parameter, which is a unique identifier of the service instance to be deleted.
