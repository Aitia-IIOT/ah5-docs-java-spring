...
inputDataModelId & \pref{DataModelIdentifier} & yes (no) & The identifier of the data model that the requester can use as input payload of the specified operation. Must be omitted if there is no input payload. \\ \hline
outputDataModelId & \pref{DataModelIdentifier} & yes (no) & The identifier of the data model that the requester can use as response payload of the specified operation. Must be omitted if there is no res\-ponse payload. \\ \hline
\end{tabularx}
\end{table}
...
inputDataModelId & \pref{DataModelIdentifier} & no (yes) & The identifier of the data model that the requester can use as input payload of the specified operation. Can be omitted if \textit{bridgeId} is specified and must be omitted if there is no input payload. \\ \hline
outputDataModelId & \pref{DataModelIdentifier} & no (yes) & The identifier of the data model that the requester can use as response payload of the spe\-cified operation. Can be omitted if \textit{bridgeId} is specified and must be omitted if there is no res\-ponse payload. \\ \hline
\end{tabularx}
\end{table}
