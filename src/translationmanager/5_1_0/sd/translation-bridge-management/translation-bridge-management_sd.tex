...
inputDataModelId & \pref{DataModelID} & yes (no) & The identifier of the data model that the consumer can use as input payload of the specified operation. Must be omitted if there is no input payload. \\ \hline
outputDataModelId & \pref{DataModelID} & yes (no) & The identifier of the data model that the consumer can use as response payload of the specified operation. Must be omitted if there is no res\-ponse payload. \\ \hline
...
alivesFrom & \pref{DateTime} & no & Requester is looking for translation bridges that was last used after the specified moment. \\ \hline
alivesTo & \pref{DateTime} & no & Requester is looking for translation bridges that was last used before the specified moment. \\ \hline
...
alivesAt & \pref{DateTime} & The moment when the translation bridge was used last time. \\ \hline
