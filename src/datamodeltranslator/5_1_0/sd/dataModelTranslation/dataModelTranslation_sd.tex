...
\begin{itemize}
    \item \textit{init-translation} accepts the data payload that need to be translated, creates an internal task for it and immediately returns a unique task ID;
