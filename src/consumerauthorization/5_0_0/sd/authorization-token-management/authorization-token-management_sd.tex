...
\begin{center}
  ...
  % Front Page Abstract
  \begin{abstract}
    This document provides service description for the \textbf{authorizationTokenManagement} service. 
  \end{abstract}
...
target & \pref{ServiceName} / \pref{EventTypeName} & no &  Requester is looking for tokens that belong to the specified service definition or event type. \\ \hline
\end{tabularx}
\end{table}
