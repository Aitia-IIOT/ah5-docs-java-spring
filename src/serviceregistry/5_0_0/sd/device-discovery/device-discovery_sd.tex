...
\begin{itemize}
    ...
    \item \textit{lookup} lists the devices that matches the filtering requirements;
\end{itemize}
...
Here, all data objects that can be part of the \textbf{device-discovery} service are listed and must be respected by the hosting System.
