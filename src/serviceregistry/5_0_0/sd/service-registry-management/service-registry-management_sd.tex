...
\ArrowheadTitle{serviceRegistryManagement} % XXX = ServiceName 
\ArrowheadServiceID{serviceRegistryManagement} % ID name of service
...
\begin{center}
  ...
  % Front Page Abstract
  \begin{abstract}
    This document provides service description for the \textbf{serviceRegistryManagement} service. 
  \end{abstract}
...
\begin{itemize}
    \item System names are case sensitive, must following the PascalCase naming convention and have to be unique within the Local Cloud.
...
\begin{table}[ht!]
\begin{tabularx}{\textwidth}{| p{3cm} | X |} \hline
\pdef{InterfaceName}    & A string identifier of an interface descriptor. Must following snake\_case naming convention. \\ \hline
