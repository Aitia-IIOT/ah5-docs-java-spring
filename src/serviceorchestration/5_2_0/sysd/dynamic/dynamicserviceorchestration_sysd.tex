...
\begin{itemize}
    ...
    \item \textbf{QoS results}: A storage to save quality of service evaluation results to the performed orchestration processes, when QoS is supported and enabled.
\end{itemize}
