...
The most common use case when a higher entity has triggered some push orchestration and wants to verify that all of them were executed without any issues and matching service instances were orchestrated and successfully pushed to the consumer systems.
