...
\rowcolor{gray!33} Field & Type & Description \\ \hline
id & \hyperref[sec:model:OrchestrationSubscriptionId]{OrchestrationSubscriptionId} & Unique identifier of the subscription record. \\ \hline
...
\rowcolor{gray!33} Field & Type & Mandatory & Description \\ \hline
authentication & \hyperref[sec:model:Identity]{Identity} & yes & The requester of the operation. \\ \hline
subscriptionIds &  \pref{List}$<$\hyperref[sec:model:OrchestrationSubscriptionId]{OrchestrationSubscriptionId}$>$ & yes & List of subscription identifiers. \\ \hline
\end{tabularx}
\end{table}
...
\rowcolor{gray!33} Field & Type & Mandatory & Description \\ \hline
authentication & \hyperref[sec:model:Identity]{Identity} & yes & The requester of the operation. \\ \hline
targetSystems &  \pref{List}$<$\pref{SystemName}$>$ & no (yes) & List of target consumer systems. Mandatory if \textit{subscriptionIds} are not provided. \\ \hline
subscriptionIds &  \pref{List}$<$\hyperref[sec:model:OrchestrationSubscriptionId]{OrchestrationSubscriptionId}$>$ & no (yes) & List of subscription identifiers. Mandatory if \textit{targetSystems} are not provided. \\ \hline
\end{tabularx}
\end{table}
...
\rowcolor{gray!33} Field & Type & Description \\ \hline
id & \hyperref[sec:model:OrchestrationJobId]{OrchestrationJobId} & Unique job identifier. \\ \hline
status & \pref{OrchestratioJobStatus} & Actual working state of the job. \\ \hline
...
subscriptionId & \hyperref[sec:model:OrchestrationSubscriptionId]{OrchestrationSubscriptionId} & Unique identifier of associated subscription record. \\ \hline
...
\msubsection{struct}{OrchestrationJobId}
