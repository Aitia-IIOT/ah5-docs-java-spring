...
serviceInstanceIds & \pref{List}$<$\pref{ServiceInstanceID}$>$ & no & Requester is looking for lock records with any of the specified service instance identifier. \\ \hline
